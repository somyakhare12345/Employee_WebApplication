...
def show_login():
    ...
    # Create a container for animation + heading together
    with st.container():
        col1 = st.columns(1)[0]
            ...
            if login_button:
                if not username or not password:
                    ...
                    with st.spinner('Authenticating...'):
                        time.sleep(1)  # simulate small loading
    ...
    st.write("")  # empty space at bottom
    ...
    st.markdown(
        ...
        <p style='text-align: center; color: gray;'>For support, contact us at: <a href='kharesomya251@gmail.com' style='color: gray;'>kharesomya251@gmail.com</a></p>
        """,
        unsafe_allow_html=True
    )
